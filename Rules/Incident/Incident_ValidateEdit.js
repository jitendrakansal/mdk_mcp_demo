...
export default function Incident_ValidateEdit(clientAPI) {
    ...
    if (!currentStatus) {
        return clientAPI.executeAction({
            "Name": '/MDK_MCP_Demo/Actions/GenericMessageBox.action',
            "Properties": {
    ...
    return clientAPI.executeAction({
        "Name": '/MDK_MCP_Demo/Actions/Incident/Incident_UpdateEntity.action',
        "Properties": {
            "OnSuccess": currentStatus === "Closed" ? "/MDK_MCP_Demo/Actions/Incident/Incident_UploadStream.action" : "/MDK_MCP_Demo/Actions/CloseModalPage_Complete.action"
        }
    })
}